...
const Footer = () => {
  return (
    <footer className="w-full border-t py-6 md:py-0 container mx-auto">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          ...
          <div className="flex gap-4">
            <Link href="/terms-and-conditions" className="text-sm font-medium transition-colors hover:text-primary">
              Terms
            </Link>
